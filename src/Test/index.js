...
import './validator';
import './testPromise';
var Plugin = WsPropsType.PropsPlugin;
// 自动生成PropTypes代码
//基础数据类型
...
console.log("window.PropsPlugin--function", Plugin.getTypeSpec(function () { }));
...
console.log("window.PropsPlugin-array-function", Plugin.getTypeSpec([function () { }]));
